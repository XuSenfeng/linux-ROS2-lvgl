...
#define GAME_2048_NUMBER_EMPTY_COLOR    lv_color_hex(0x1E1E1E)   // 空格深灰，衬托黄色方块
#define GAME_2048_NUMBER_2_COLOR        lv_color_hex(0xFFF9C4)   // 非常浅黄
#define GAME_2048_NUMBER_4_COLOR        lv_color_hex(0xFFF59D)
#define GAME_2048_NUMBER_8_COLOR        lv_color_hex(0xFFF176)
#define GAME_2048_NUMBER_16_COLOR       lv_color_hex(0xFFEE58)
#define GAME_2048_NUMBER_32_COLOR       lv_color_hex(0xFFEB3B)   // 经典黄
#define GAME_2048_NUMBER_64_COLOR       lv_color_hex(0xFDD835)
#define GAME_2048_NUMBER_128_COLOR      lv_color_hex(0xFBC02D)
#define GAME_2048_NUMBER_256_COLOR      lv_color_hex(0xF9A825)
#define GAME_2048_NUMBER_512_COLOR      lv_color_hex(0xF57F17)
#define GAME_2048_NUMBER_1024_COLOR     lv_color_hex(0xFFC107)   // Amber 主色
#define GAME_2048_NUMBER_2048_COLOR     lv_color_hex(0xFFA000)   // 深金黄
...
void ui_Game2048Page_init(void *arg)
{
    ...
    int height = lv_obj_get_height(lv_scr_act());
    int width = lv_obj_get_width(lv_scr_act());
    int buttrn_M_size;
    if(height - width > 20){
        buttrn_M_size = width;
    }
    else if(width - height > 20){
        buttrn_M_size = height;
    }else if(height > width){
        buttrn_M_size = width - 20;
    }else{
        buttrn_M_size = height - 20;
    }
    ...
    lv_obj_set_size(ui_Game2048BtnM,buttrn_M_size,buttrn_M_size);
    if(height > width){
        lv_obj_set_align(ui_Game2048BtnM, LV_ALIGN_TOP_MID);
    }else{
        lv_obj_set_align(ui_Game2048BtnM, LV_ALIGN_LEFT_MID);
    }


    lv_obj_t * new_game_btn = lv_btn_create(ui_Game2048Page);
    lv_obj_align(new_game_btn, LV_ALIGN_BOTTOM_MID, -80, -10);
    lv_obj_set_size(new_game_btn,95,40);
    ...
    lv_obj_align(return_btn, LV_ALIGN_BOTTOM_MID, 80, -10);
    lv_obj_set_size(return_btn,95,40);
    ...
    sprintf(strbuf,"Sc: %4d",Game_2048.score);
    lv_label_set_text(ui_Game2048ScLabel,strbuf);
    lv_obj_align(ui_Game2048ScLabel, LV_ALIGN_BOTTOM_MID, 0, -80);
...
void ui_game_2048_button(lv_obj_t * ui_HomeScreen, lv_obj_t * ui_AppIconContainer, int x, int y, void (*button_cb)(lv_event_t *)){
    ...
    lv_obj_set_x(ui_Game2048Btn, x);
    lv_obj_set_y(ui_Game2048Btn, y);
    lv_obj_add_flag(ui_Game2048Btn, LV_OBJ_FLAG_SCROLL_ON_FOCUS);
    lv_obj_remove_flag(ui_Game2048Btn, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_add_event_cb(ui_Game2048Btn, button_cb, LV_EVENT_CLICKED, "Game2048Page");
}
